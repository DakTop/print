 ...
 * Time    12:53
 */
public class LabelModelSix extends LabelModel {
    ...
    private LabelPoint shopProductName = mLabelPointFactory.createPointWithRatioXY(0.242f, 0.289f, 8, 4);
    private LabelPoint unit = mLabelPointFactory.createPointWithRatioXY(0.128f, 0.500f, 4, 4);

    private LabelPoint shopProductPrice = mLabelPointFactory.createPointWithRatioXY(0.371f, 0.736f, 8 * 8, 8 * 3);


    private List<LabelProductInfo> productInfoList;

    public LabelModelSix(List<LabelProductInfo> productInfoList) {
        this.productInfoList = productInfoList;
    }


    //单行1号字体
    private LabelPoint shopProductNameSmallSingleLine = mLabelPointFactory.createPointWithRatioXY(0.266f, 0.286f, -2 * 8, 8);
    //单行2号字体
    private LabelPoint shopProductNameBigSingleLine = mLabelPointFactory.createPointWithRatioXY(0.270f, 0.250f, -2 * 8, 8);
    //字符超过16为 上下显示
    private LabelPoint productNameLineFirst = mLabelPointFactory.createPointWithRatioXY(0.266f, 0.240f, -2 * 8, 8);
    private LabelPoint productNameLineSecond = mLabelPointFactory.createPointWithRatioXY(0.266f, 0.319f, -2 * 8, 8);
    private LabelPoint productNameLineThird = mLabelPointFactory.createPointWithRatioXY(0.266f, 0.398f, -2 * 8, 8);
    //
    private static final int BIG_FONT_SIZE_SINGLE_LINE_COUNT = 14;
    private static final int SMALL_FONT_SIZE_SINGLE_LINE_COUNT = 28;
    private static final int SMALL_FONT_SIZE_TWO_LINE_COUNT = 56;
    ...
    public byte[] getPrintBytes() {
        ...
        //tsc.addHome(); // 有HOME的时候会跳过一张纸，没home的时候第一张打印不准
        tsc.addCls();// 清除打印缓冲区
