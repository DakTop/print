...
public class LabelModelThree extends LabelModel {
    ...
    private LabelPoint unit = mLabelPointFactory.createPointWithRatioXY(0.136f, 0.571f, 8, 0);
    private LabelPoint shopProductPrice = mLabelPointFactory.createPointWithRatioXY(0.469f, 0.571f, 8 * 8, 0);

    private List<LabelProductInfo> productInfoList;

    public LabelModelThree(List<LabelProductInfo> productInfoList) {
        this.productInfoList = productInfoList;
    }

    //单行1号字体
    private LabelPoint shopProductNameSmallSingleLine = mLabelPointFactory.createPointWithRatioXY(0.227f, 0.040f, -2 * 8, 8);
    //单行2号字体
    private LabelPoint shopProductNameBigSingleLine = mLabelPointFactory.createPointWithRatioXY(0.220f, 0.010f, -2 * 8, 8);
    //字符超过16为 上下显示
    private LabelPoint productNameLineFirst = mLabelPointFactory.createPointWithRatioXY(0.220f, 0.002f, -2 * 8, 8);
    private LabelPoint productNameLineSecond = mLabelPointFactory.createPointWithRatioXY(0.220f, 0.082f, -2 * 8, 8);
    //
